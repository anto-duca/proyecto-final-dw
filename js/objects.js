...
const CONSULTA_ONLINE = new Servicios (4, 'Consulta inicial online', '~/../multimedia/consultas-online.jpg', 'Trabajemos juntos en cambiar tus hábitos alimenticios con una primera llamada', '', 'recetarios', 500);
const CONSULTA_PRESENCIAL = new Servicios (5, 'Consulta inicial presencial', '~/../multimedia/consultas-presenciales.jpg', 'En mi consultorio podremos iniciar un camino para cambiar tus hábitos', '', 'recetarios', 500);
